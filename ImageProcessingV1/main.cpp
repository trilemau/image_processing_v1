...
void processImage(IImageProcessing& image_processing)
{
    ...
    std::cout << "------" << image_processing.Info() << "------\n";
...
void comparison()
{
    ...
    //processImage(image_processing_cpp);
    processImage(image_processing_opencl);
}
